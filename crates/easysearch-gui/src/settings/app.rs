...
use super::view_models::page_plugin::{PluginMessage, PluginViewModel};
...
impl SettingsApp {
    ...
    fn new(shared_settings: Arc<RwLock<Settings>>) -> (Self, Task<Message>) {
...
pub fn run_settings_app(settings: Arc<RwLock<Settings>>) -> iced::Result {
    iced::application("EasySearch 设置", SettingsApp::update, SettingsApp::view)
        ...
        .run_with(move || SettingsApp::new(settings))
}
